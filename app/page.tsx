    ...
    <>
      ...
      <section className="hero">
        <div className="hero-text">
          <h1 className="hero-h1">
            Hi, I&rsquo;m <span className="name">Aiqi</span>
          </h1>
          <h2 className="hero-h2">
            I turn complex legal workflows into{" "}
            <span className="hl">UX designs</span> that support humans make
            informed decisions.
          </h2>
          <p className="hero-sub">
            I work with early-stage legal tech teams to design products &amp;
            systems that humans can understand, navigate around and collaborate
            with — sourced from personal legal experience, not a generic UX
            playbook.
          </p>
        </div>
      ...
      <section className="about" id="about">
        <h2 className="about-heading">
          A <span className="hl">designer</span> who speaks some{" "}
          <span className="hl">legalese</span>
        </h2>
        <p className="about-body">
          ...
          understand when technology can make legal systems easier to deal with,
          and when humans should make the judgment.
        </p>
      ...
      <section className="work" id="work">
        ...
        <div className="case-studies">
          <h2 className="work-heading">
            Case studies of <span className="hl">data</span> and{" "}
            <span className="hl">workflow</span> apps
          </h2>
